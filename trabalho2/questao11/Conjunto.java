...
class Conjunto
{
    ...
    void Uniao(Conjunto c2) {
        ...
        System.out.println("União (ignoremos os 0's): "+Arrays.toString(novo));
    }

    void Interseccao(Conjunto c2) {
        ...
        System.out.println("Intersecção (ignoremos os 0's): "+Arrays.toString(novo));
    }
